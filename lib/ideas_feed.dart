    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          new IdeaItem(title: "Closed captions for horror movies should be hard to read when indicating a quiet noise.", description: "", url: "https://google.com", ups: "2", date: "2 day ago", source: "Reddit"),
